...
The GTX DEX Test Token Faucet provides developers and users with test tokens needed for development, testing, and experimentation across multiple testnets including GTX testnet and Base Sepolia.
...
The faucet provides the following test tokens on GTX testnet:
...
<Steps>
  <Step title="Connect Wallet">
    Connect your wallet to the GTX testnet
  </Step>
...
| **Wrong Network** | Connected to mainnet | Switch to GTX testnet |
...
To use the faucet, ensure your wallet is connected to GTX testnet:

```javascript
// Network configuration for GTX testnet
const gtxTestnet = {
  chainId: 1802,
  chainName: 'GTX Testnet',
  nativeCurrency: {
    name: 'Ethereum',
    symbol: 'ETH',
    decimals: 18
