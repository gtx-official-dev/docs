...
|-------|--------|---------|-------------|
| **Wrapped Ethereum** | WETH | GTX Testnet | Primary base asset |
| **USD Coin** | USDC | GTX Testnet | Stable quote currency |
| **Wrapped Bitcoin** | WBTC | GTX Testnet | Bitcoin representation |
| **Chainlink** | LINK | GTX Testnet | Oracle token |
| **Pepe** | PEPE | GTX Testnet | Meme token |
