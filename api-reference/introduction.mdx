...
<Warning>
Currently, GTX DEX API endpoints do not require authentication for market data. User-specific endpoints require the user's wallet address as a parameter.
</Warning>
...
- **Documentation Issues**: [GitHub Issues](https://github.com/Great-Trading-eXperience/gtx-docs/issues)
- **API Support**: [support@gtxdex.xyz](mailto:support@gtxdex.xyz)
- **Developer Community**: [Discord](https://discord.gg/gtxdex)
